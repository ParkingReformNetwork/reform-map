...
bootstrapPage(
    ...
    tags$head(
        ...
        tags$script(
            src = "https://kit.fontawesome.com/37a140b4a8.js",
            crossorigin = "anonymous"
        ),
        tags$script(src = "add_highlights.js")
        # tags$meta(name = "viewport", content = "width=1600"), uiOutput("body")
    ),
            ...
            hidden(
                withTags({
                    div(
                        id = "city_detail_info",
                        fluidRow(
                            class = "clicked_city_first_row",
                            actionButton("close_detail", "x"),
